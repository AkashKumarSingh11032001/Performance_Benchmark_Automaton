...
def excelPlot(data):
    ...
    Cellformat_1 = workbook.add_format({'border': 2})
    Cellformat_2 = workbook.add_format({'border': 3})
    Cellformat_3 = workbook.add_format({'border': 1})

    # Drive Standard Configuration.
    worksheet.write("A1", "Standard Device Config.", Cellformat_1)
    worksheet.write("A2", "Firware Rev.", Cellformat_1)
    worksheet.write("A3", "Drive Capacity", Cellformat_1)
    worksheet.write("B2", data[0][0], Cellformat_1)
    worksheet.write("B3", data[0][1], Cellformat_1)

    # Standard FIO Scripts
    worksheet.write("A6", "BURST SEQUENTIAL WRITE", Cellformat_1)
    worksheet.write("A7", "BURST SEQUENTIAL READ", Cellformat_1)
    worksheet.write("A8", "SUBSTAIN SEQUENTIAL WRITE", Cellformat_1)
    worksheet.write("A9", "SUBSTAIN SEQUENTIAL READ", Cellformat_1)
    worksheet.write("A10", "BURST RANDOM WRITE", Cellformat_1)
    worksheet.write("A11", "BURST RANDOM READ", Cellformat_1)
    worksheet.write("A12", "BURST RANDOM WRITE OIO", Cellformat_1)
    worksheet.write("A13", "BURST RANDOM READ OIO", Cellformat_1)

    # Table column name
    worksheet.write("B5", "SIZE", Cellformat_1)
    worksheet.write("C5", "BLOCK SIZE", Cellformat_1)
    worksheet.write("D5", "IO-DEPTHS", Cellformat_1)
    worksheet.write("E5", "THREADS", Cellformat_1)
    worksheet.write("F5", "PRECONDITION", Cellformat_1)
    worksheet.write("G5", "IOPS", Cellformat_1)
    worksheet.write("H5", "BANDWIDTH", Cellformat_1)
    worksheet.write("I5", "AVG. LATENCY", Cellformat_1)
    worksheet.write("J5", "50th", Cellformat_1)
    worksheet.write("K5", "75th", Cellformat_1)
    worksheet.write("L5", "99th", Cellformat_1)
    worksheet.write("M5", "99.9th", Cellformat_1)
    worksheet.write("N5", "99.99th", Cellformat_1)
    worksheet.write("O5", "99.999th", Cellformat_1)
    worksheet.write("P5", "99.9999th", Cellformat_1)
